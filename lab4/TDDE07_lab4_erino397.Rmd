...
### (a)
In Figure 1 I have plotted the normal approximation of the MLE of $\beta$ with uncertainty. The MLE of $\beta$ can be seen in Table 1. Significant covariates are MinBidShare, Sealed, VerifyID and MajBlem.
